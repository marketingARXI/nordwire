...
const translations = {
  pt: {
    ...
    'monitoring.dashboardCta': 'Ver dashboard em tempo real',
    'dashboardModal.kicker': 'Dashboard NordWire',
    'dashboardModal.position': 'Monitorização industrial em tempo real.',
    'dashboardModal.closeLabel': 'Fechar dashboard',
    'dashboardModal.featuresLabel': 'Funcionalidades do dashboard NordWire',
    'dashboardModal.oee.title': 'OEE em tempo real',
    'dashboardModal.oee.description': 'Acompanha a eficiência de cada linha ao segundo.',
    'dashboardModal.downtime.title': 'Deteção automática de paragens',
    'dashboardModal.downtime.description': 'Identifica e classifica o downtime sem intervenção manual.',
    'dashboardModal.multiline.title': 'Visão multi-linha',
    'dashboardModal.multiline.description': 'Monitoriza várias máquinas em simultâneo num só ecrã.',
    'dashboardModal.history.title': 'Histórico e análise',
    'dashboardModal.history.description': 'Compara turnos e identifica padrões de perda.',
    'cloud.eyebrow': 'Nuvem',
  ...
  en: {
    ...
    'monitoring.dashboardCta': 'See live dashboard',
    'dashboardModal.kicker': 'NordWire Dashboard',
    'dashboardModal.position': 'Real-time industrial monitoring.',
    'dashboardModal.closeLabel': 'Close dashboard',
    'dashboardModal.featuresLabel': 'NordWire dashboard features',
    'dashboardModal.oee.title': 'Real-time OEE',
    'dashboardModal.oee.description': "Track each line's efficiency by the second.",
    'dashboardModal.downtime.title': 'Automatic downtime detection',
    'dashboardModal.downtime.description': 'Identifies and classifies downtime with no manual input.',
    'dashboardModal.multiline.title': 'Multi-line view',
    'dashboardModal.multiline.description': 'Monitor several machines at once on a single screen.',
    'dashboardModal.history.title': 'History & analysis',
    'dashboardModal.history.description': 'Compare shifts and spot loss patterns.',
    'cloud.eyebrow': 'Cloud',
