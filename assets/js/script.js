...
const translations = {
  pt: {
    ...
    'monitoring.dashboardCta': 'Ver como os sensores captam a atividade',
    ...
    'dashboardModal.title': 'Da máquina ao ecrã, em tempo real',
    'dashboardModal.subtitle': 'Os sensores NordWire captam a atividade de cada máquina e transformam-na na informação que vês no dashboard.',
    'dashboardModal.oee.title': 'Sensores em cada linha',
    'dashboardModal.oee.description': 'Os dispositivos NordWire ligados às máquinas captam a atividade em contínuo, e é essa leitura que alimenta os contadores e o estado de cada máquina no dashboard.',
    'dashboardModal.downtime.title': 'Recolha automática',
    'dashboardModal.downtime.description': 'Os dados são captados ao segundo, sem intervenção manual, para que o OEE e as paragens que vês sejam sempre reais e atualizados.',
    'dashboardModal.multiline.title': 'Envio para a cloud',
    'dashboardModal.multiline.description': 'A informação sobe em tempo real para a plataforma NordWire, permitindo acompanhar tudo à distância no mesmo ecrã.',
    'dashboardModal.history.title': 'Do sinal ao ecrã',
    'dashboardModal.history.description': 'Cada sinal captado transforma-se nos gráficos, na timeline e nos indicadores que vês no dashboard.',
    'cloud.eyebrow': 'Nuvem',
